...
(function (global, factory) {
  ...
  var render = {
    ...
    initContainer: function initContainer() {
	  ...
	  var SET_WIDTH = (Number(WINDOW_WIDTH)*50)/100
	  
	 // alert(SET_WIDTH)
	 /*  
	  var containerData = {
			width: Math.max(container.offsetWidth,  480),
	 ...
	 if (WINDOW_WIDTH <459){
		   ...
		   var containerData = {
			width: Math.max(container.offsetWidth,  Number(200)),
			height: Math.max(container.offsetHeight,  Number(200))
		  };
	  }else{
		   var containerData = {
			width: Math.max(container.offsetWidth,  466),
			height: Math.max(container.offsetHeight,  300)
		  };
	  }
