...
module.exports = {
      ...
      getFormat: function(value,format, options) {
	   ...
	   ifCond:function(v1, operator, v2, options){
		...
		ifCondition:function(v1, operator, v2, operator, v3, operator, v4, operator, v5, operator, v6 ,options){
			switch (operator) {
				case '&&':
					return (v1 && v2 && v3 && v4 && v5 == v6) ? options.fn(this) : options.inverse(this);
				case '||':
					return (v1 || v2 || v3 || v4 || v5 == v6) ? options.fn(this) : options.inverse(this);
			}
		},
